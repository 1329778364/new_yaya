...
<view class="container" style="background-color:rgb(237,237,237)">
<!--<cu-custom bgColor="bg-gradual-blue" :isBack="false">
	...
	<view class="tui-header-banner">
		<view class="tui-hot-search">
			<view>热搜</view>
			<view v-for="(item, index) in hotTag" :key="index">
				<view class="tui-hot-tag" @tap="search">{{item}}</view>
			</view>
		</view>
	...
	<view class="page">
		<view class="firstTitle bg-white topRadius margin-top-sm ">
			<text>教育咨询</text>
			<text>查看更多 > </text>	
		</view>
		<view class="cu-list grid col-3 bottomRadius no-border">
			<view class="cu-item" v-for="(item,index) in education" :key="index" v-if="index<gridCol*2" @click="chooseOne(item)">
		...
		<view class="cu-list grid col-4 bottomRadius no-border">
			<view class="cu-item" v-for="(item,index) in lifeService" :key="index" v-if="index<gridCol*2" :data-key="[item.name, item.englishName]" @click="chooseOne">
				<view :class="['cuIcon-' + item.cuIcon,'text-' + item.color]">
					<view class="cu-tag badge" v-if="item.badge!=0">
						<block v-if="item.badge!=1">{{item.badge>99?'99+':item.badge}}</block>
					</view>
		...
		<view class="firstTitle bg-white margin-top-sm topRadius">
			<text>娱乐休闲</text>
			<text style="justify-content: center;">查看更多 ></text>
		</view>
		<view class="cu-list grid col-4 bottomRadius no-border">
			<view class="cu-item" v-for="(item,index) in entertainment" :key="index" v-if="index<gridCol*2" :data-key="[item.name, item.englishName]" @click="chooseOne">
				<view :class="['cuIcon-' + item.cuIcon,'text-' + item.color]">
					<view class="cu-tag badge" v-if="item.badge!=0">
						<block v-if="item.badge!=1">{{item.badge>99?'99+':item.badge}}</block>
					</view>
	...
	<view class="tui-product-box">
		...
		<!-- <view class="tui-product-list">
			<view class="tui-product-container">
				<block v-for="(item,index) in  " :key="index" v-if="(index+1)%2!=0">
